...
var socketModule = {
    ...
    processJoinRoom: function (obj) {
        ...
        for (var i = 0; i < 12; i++) {
            if (i <= 12 - Math.ceil(obj.data.serial_num)) {
    ...
    processNotyChooseChip: function (obj) {
        console.log("NotyChooseChip", obj);
        if (appData.is_super) {
            $('.clickToLook').css('left', '70%');
        }
    ...
    processWinJoy: function (obj) {
        ...
        console.log(appData.winJoy_dict);
    },
            ...
            for (var i = 0; i < 12; i++) {
                for (var j = 0; j < obj.data.length; j++) {
                    if (appData.player[i].account_id == obj.data[j].account_id) {
                        ...
                        console.log('玩家的牌', appData.player[i].card);
                    }
                }
            }
...
var viewMethods = {
    ...
    roundEnd: function () {
        setTimeout(function () {
            DynLoading.goto('flower12', 'i=' + globalData.roomNumber);
...
console.log(globalData.fileUrl);
