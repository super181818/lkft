...
var viewMethods = {
    ...
    showMessage: function() {
        console.log('true',appData.player[0].account_id!=userData.accountI)
        if(appData.player[0].account_id!=userData.accountId) return; //观战功能
...
var audioModule = {
    ...
    loadAllAudioFile: function() {
        ...
        for (var i = 0; i < audioMessageUrl.length; i++) {
            this.loadAudioFile(this.audioUrl + 'files/audio/sound/' + audioMessageUrl[i], audioMessageName[i]);
        }
    }
};
