...
var viewMethods = {
    ...
    resetCardOver: function(num) {
        if (num == 1) {
           ...
           // $(".cardOver .card511").css("right", "14.63vh");
           // $(".cardOver .card521").css("right", "16.63vh");
           // $(".cardOver .card531").css("right", "18.63vh");
        } else if (num == 6) {
           // $(".cardOver .card611").css("left", "14.63vh");
          //  $(".cardOver .card621").css("left", "16.63vh");
            //$(".cardOver .card631").css("left", "18.63vh");
...
var memCoin = [
    ...
    {top: '43%', left: coinLeft3},
    {top: '27%', left: coinLeft4},
    {top:  '9%', right: '4.5vh'},
    {top:  '9%', left:  '4.5vh'},
    {top: '27%', left:  '4.5vh'},
    {top: '43%', left:  '4.5vh'},
